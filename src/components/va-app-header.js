  ...
  render(){    
    ...
    <header class="app-header">
      ...
      <nav class="app-top-nav">
        ...
        ${this.user.accessLevel == 2 ? html`<a href="/newhaircut" @click="${anchorRoute}">Add Haircut</a>`
        : ``}   
    ...
    <sl-drawer class="app-side-menu" placement="start" class="drawer">
      ...
      <nav class="app-side-menu-items">
        ...
        ${this.user.accessLevel == 2 ? html`<a href="/newhaircut" @click="${this.menuClick}">Add Haircut</a>`
        : ``}   
        <a href="/hairdressers" @click="${this.menuClick}">Find A Hairdresser</a>
        <a href="/haircuts" @click="${this.menuClick}">Find A Haircut</a>
        <a href="/favhaircuts" @click="${this.menuClick}">Favourite Haircuts</a>
